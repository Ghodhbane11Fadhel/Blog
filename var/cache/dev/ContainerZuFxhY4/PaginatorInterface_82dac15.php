...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer7779f && ($this->initializer7779f->__invoke($valueHoldere2883, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer7779f) || 1) && $this->valueHoldere2883 = $valueHoldere2883;

        if ($this->valueHoldere2883 === $returnValue = $this->valueHoldere2883->paginate($target, $page, $limit, $options)) {
            return $this;
        }
